...
export default function AdminLayout() {
   ...
   const desktopLinkStyles = ({ isActive }) =>
      `block py-2.5 px-3 rounded-lg font-medium text-[0.95rem] transition-all duration-200 ease-in-out ${isActive
   ...
   const mobileLinkStyles = ({ isActive }) =>
      `flex flex-col items-center justify-center min-w-[80px] flex-1 h-full snap-center text-[0.7rem] font-semibold transition-colors ease-in-out ${isActive
   ...
   return (
      <div className="group flex min-h-screen flex-col lg:flex-row">
         ...
         {/* ==========================================
            ...
            ========================================== */}
         <aside className="hidden lg:flex print:hidden w-[180px] bg-[#fff4fb] text-gray-800 py-6 px-4 sticky top-[90px] h-[calc(100vh-90px)] border-r border-purple-100 flex-col gap-5 box-border">
         ...
         <nav className="
            ...
            flex flex-nowrap overflow-x-auto snap-x scrollbar-none lg:hidden print:hidden
